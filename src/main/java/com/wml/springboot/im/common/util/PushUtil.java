package com.wml.springboot.im.common.util;

import com.wml.springboot.im.entity.Apply;
import com.wml.springboot.im.packet.LayimToClientAddFriendMsgBody;
...
public final class PushUtil {
    ...
    public static void pushAddFriendMessage(long applyid){
        ...
        Apply apply = new Apply();//applyService.getApply(applyid);
        apply.setUid(1);
