package com.wml.springboot.im.server.handler;

import java.nio.ByteBuffer;

import com.fasterxml.jackson.databind.ObjectMapper;
import com.wml.springboot.im.common.Protocol;
import com.wml.springboot.im.common.intf.LayimAbsMsgProcessor;
import com.wml.springboot.im.common.processor.LayimMsgProcessorManager;
import com.wml.springboot.im.common.util.ByteUtil;
import com.wml.springboot.im.packet.LayimMsgProperty;
import com.wml.springboot.im.packet.LayimResponseBody;
    ...
    */
    ...
    private WsResponse handleDetail(WsRequest websocketPacket, byte[] bytes, Opcode opcode, ChannelContext channelContext) throws Exception {
        ...
        if (opcode == Opcode.TEXT) {
            ...
            //LayimMsgProperty property = objectMapper.readValue(text,LayimMsgProperty.class);
