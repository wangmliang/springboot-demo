...
public interface SecResourcesMapper {
	...
	/**
	 * 查询SecResources对象的数据集合
	 * @return SecResources对象集合
	 * @author Miles
	 * 2018-04-27 12:17:59  Created
	 */
	...
	/**
	 * 根据SecResources对象更新对应数据（属性通过非空验证，为空属性不参与操作）
	 * @param  record	SecResources对象
	 * @return 更新影响行数
	 * @author Miles
	 * 2018-04-27 12:17:59  Created
